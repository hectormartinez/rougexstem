...
XS(XS_XML__Parser__Expat_ParserCreate)
{
    dXSARGS;
    if (items != 3)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::ParserCreate(self_sv, enc_sv, namespaces)");
    {
	SV *	self_sv = ST(0);
	SV *	enc_sv = ST(1);
...
XS(XS_XML__Parser__Expat_ParserRelease)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::ParserRelease(parser)");
    {
...
XS(XS_XML__Parser__Expat_ParserFree)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::ParserFree(parser)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
#line 1360 "Expat.xs"
	{
...
XS(XS_XML__Parser__Expat_ParseString)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::ParseString(parser, sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	sv = ST(1);
	int	RETVAL;
...
XS(XS_XML__Parser__Expat_ParseStream)
{
    dXSARGS;
    if (items != 3)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::ParseStream(parser, ioref, delim)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	ioref = ST(1);
	SV *	delim = ST(2);
...
XS(XS_XML__Parser__Expat_ParsePartial)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::ParsePartial(parser, sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	sv = ST(1);
	int	RETVAL;
...
XS(XS_XML__Parser__Expat_ParseDone)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::ParseDone(parser)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	int	RETVAL;
	dXSTARG;
...
XS(XS_XML__Parser__Expat_SetStartElementHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetStartElementHandler(parser, start_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	start_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetEndElementHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetEndElementHandler(parser, end_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	end_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetCharacterDataHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetCharacterDataHandler(parser, char_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	char_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetProcessingInstructionHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetProcessingInstructionHandler(parser, proc_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	proc_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetCommentHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetCommentHandler(parser, cmnt_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	cmnt_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetDefaultHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetDefaultHandler(parser, dflt_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	dflt_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetUnparsedEntityDeclHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetUnparsedEntityDeclHandler(parser, unprsd_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	unprsd_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetNotationDeclHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetNotationDeclHandler(parser, notation_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	notation_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetExternalEntityRefHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetExternalEntityRefHandler(parser, extent_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	extent_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetExtEntFinishHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetExtEntFinishHandler(parser, extfin_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	extfin_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetEntityDeclHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetEntityDeclHandler(parser, entdcl_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	entdcl_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetElementDeclHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetElementDeclHandler(parser, eledcl_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	eledcl_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetAttListDeclHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetAttListDeclHandler(parser, attdcl_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	attdcl_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetDoctypeHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetDoctypeHandler(parser, doctyp_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	doctyp_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetEndDoctypeHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetEndDoctypeHandler(parser, doctypfin_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
...
XS(XS_XML__Parser__Expat_SetXMLDeclHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetXMLDeclHandler(parser, xmldec_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	xmldec_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetBase)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetBase(parser, base)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	base = ST(1);
#line 1793 "Expat.xs"
...
XS(XS_XML__Parser__Expat_GetBase)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::GetBase(parser)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	RETVAL;
#line 1811 "Expat.xs"
...
XS(XS_XML__Parser__Expat_PositionContext)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::PositionContext(parser, lines)");
    SP -= items;
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
...
XS(XS_XML__Parser__Expat_GenerateNSName)
{
    dXSARGS;
    if (items != 4)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::GenerateNSName(name, xml_namespace, table, list)");
    {
	SV *	name = ST(0);
...
XS(XS_XML__Parser__Expat_DefaultCurrent)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::DefaultCurrent(parser)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
#line 1919 "Expat.xs"
	{
...
XS(XS_XML__Parser__Expat_RecognizedString)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::RecognizedString(parser)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	RETVAL;
#line 1929 "Expat.xs"
...
XS(XS_XML__Parser__Expat_GetErrorCode)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::GetErrorCode(parser)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	int	RETVAL;
	dXSTARG;
...
XS(XS_XML__Parser__Expat_GetCurrentLineNumber)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::GetCurrentLineNumber(parser)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	int	RETVAL;
	dXSTARG;
...
XS(XS_XML__Parser__Expat_GetCurrentColumnNumber)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::GetCurrentColumnNumber(parser)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	int	RETVAL;
	dXSTARG;
...
XS(XS_XML__Parser__Expat_GetCurrentByteIndex)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::GetCurrentByteIndex(parser)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	long	RETVAL;
	dXSTARG;
...
XS(XS_XML__Parser__Expat_GetSpecifiedAttributeCount)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::GetSpecifiedAttributeCount(parser)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	int	RETVAL;
	dXSTARG;
...
XS(XS_XML__Parser__Expat_ErrorString)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::ErrorString(code)");
    {
...
XS(XS_XML__Parser__Expat_LoadEncoding)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::LoadEncoding(data, size)");
    {
...
XS(XS_XML__Parser__Expat_FreeEncoding)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::FreeEncoding(enc)");
    {
	Encinfo *	enc;
...
XS(XS_XML__Parser__Expat_OriginalString)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::OriginalString(parser)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	RETVAL;
#line 2089 "Expat.xs"
...
XS(XS_XML__Parser__Expat_SetStartCdataHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetStartCdataHandler(parser, startcd_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	startcd_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_SetEndCdataHandler)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SetEndCdataHandler(parser, endcd_sv)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	endcd_sv = ST(1);
	SV *	RETVAL;
...
XS(XS_XML__Parser__Expat_UnsetAllHandlers)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::UnsetAllHandlers(parser)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
#line 2143 "Expat.xs"
	{
...
XS(XS_XML__Parser__Expat_ElementIndex)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::ElementIndex(parser)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	int	RETVAL;
	dXSTARG;
...
XS(XS_XML__Parser__Expat_SkipUntil)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::SkipUntil(parser, index)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
...
XS(XS_XML__Parser__Expat_Do_External_Parse)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: XML::Parser::Expat::Do_External_Parse(parser, result)");
    {
	XML_Parser	parser = INT2PTR(XML_Parser,SvIV(ST(0)));
	SV *	result = ST(1);
	int	RETVAL;
